...
const InitialRiskList = (data: TRiskData[], batchSize: number) => {
	let batches = [];
...
const RiskList = (props: TRiskList) => {
	const { data } = props;
	...
	const res = InitialRiskList(data, 5);
	return <div style={styleContainer}>{RiskListCard(res)}</div>;
};
